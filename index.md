...
Note: For the time being only a single grup_kod is allowed. The API
allows using multiple grup_kod as well to download for more than bank
groups. This will be added in future versions.
